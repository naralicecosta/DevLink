        ...
        <div className="flex items-center flex-col min-h-screen pb-7 px-2" onSubmit={handleRegister}>
            ...
            <form className="flex flex-col mt-8 mb-3 w-full max-w-xl">
                ...
                {nameInput !== '' && (
                    ...
                    <article className=" w-11/12 max-w-lg flex flex-col items-center justify-between bg-zinc-900 rounded px-1 p-3"
                ...
                <button type="submit" className="mb-7 bg-blue-500 h-9 rounded-md text-white font-medium gap-4 flex justify-center items-center">
                    Cadastrar
